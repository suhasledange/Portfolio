...
const Card = ({heading,TechStack,Img,para,git,live,liveText,year}) => {
  return (
    ...
    <div className='absolute top-0 left-0 w-full h-full bg-gray-800 opacity-0 group-hover:opacity-90 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 flex items-center justify-center gap-10'>
    ...
    <div className='p-5'>
      <div className='w-[90%] mx-auto h-[17rem] py-5'>
        <img className='w-full h-full bg-cover rounded-lg' src={Img} alt={heading} />
      </div>
