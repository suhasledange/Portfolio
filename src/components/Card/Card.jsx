  ...
  return (
    <div className='relative border dark:shadow-xl dark:drop-shadow-xl dark:border-gray-800 dark:bg-gray-800 bg-gray-50 rounded-md shadow-md pb-4 pt-2 cursor-pointer mx-auto w-[90%] md:w-full overflow-hidden group flex flex-col justify-between'>
      ...
      <div className='p-3 md:p-5'>
        <div className=' rounded-lg w-full md:w-[90%] mx-auto h-[17rem] py-5 hover:scale-105 duration-300'>
          ...
          <LazyLoadImage
            className='dark:brightness-75 dark:contrast-125 bg-cover object-contain rounded-lg hover:shadow-xl'
            alt={heading}
            src={Img}
            effect="blur" 
            threshold={200}
